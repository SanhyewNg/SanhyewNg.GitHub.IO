...
- [:lucide-cctv: Smart Surveillance System](Smart-Surveillance-System.md)  
  Real-time multi-camera video intelligence with tracking, ReID, and behavior analysis.

- [:lucide-microscope: Medical Imaging Analysis SaaS](Medical-Imaging-Analysis-SaaS.md)  
  AI system for processing and analyzing multi-modality medical images (2D/3D).

- [:lucide-graduation-cap: AI Learning Path Platform](AI-Learning-Path-Platform.md)  
  Structured platform for learning AI from fundamentals to advanced systems.
